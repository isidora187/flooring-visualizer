...
const flooringOptions = [
  ...
  { name: "Patricia Laminat",image: "/Patricia1 (1).png", code: "PRK100", price: "8.51 € / m2€", glb: "/laminat-2.glb", usdz: "/laminat-2.usdz",link:"/patricia/" },
  { name: "Amalfi Dvoslojni Parket",image: "/BGP_GAIA_vesuvio_AMALFI_rr9snq.jpg", code: "PRK100", price: " 39 € / m2", glb: "/laminat-3.glb", usdz: "/laminat-3.usdz",link:"/amalfi-dvoslojni-parket-2/" },
  { name: "Capri Dvoslojni Parket",image: "/BGP_GAIA_vesuvio_CAPRI_ojlezq.jpg", code: "PRK100", price: "39 € / m2", glb: "/parket-1.glb", usdz: "/parket-1.usdz",link:"/capri-dvoslojni-parket/" },
  { name: "Kant-Tehno parket",image: "/kant-ali-industrijski-parket-1.jpg", code: "PRK100", price: "kontakt za ceno", glb: "/parket-2.glb", usdz: "/parket-2.usdz",link:"/kant-tehno-parket/" },
  { name: "LVT/SPC Vinil Akra",image: "/akra-vinilspc.png", code: "PRK100", price: "21.99 € / m2", glb: "/parket-3.glb", usdz: "/parket-3.usdz",link:"/akra/" },
  { name: "Parket Ribja Kost",image: "/GAIA_fiordo_doga_zvyfrh.jpg", code: "PRK100", price: "33.12€ / m2", glb: "/parket-4.glb", usdz: "/parket-4.usdz",link:"/akra/" },
  { name: "LVT/SPC Vinil Platano",image: "/Vinil Platano.png", code: "PRK100", price: "21.99 € / m2", glb: "/parket-5.glb", usdz: "/parket-5.usdz" ,link:"/platano/"},
  ...
  { name: "Fiordo dvoslojni parket",image: "/GAIA_fiordo.jpg", code: "PRK100", price: "45.50 € / m2", glb: "/parket-10.glb", usdz: "/parket-10.usdz",link:"/fiordo-dvoslojni-parket/" },
...
const ARFlooringVisualizer = () => {
  ...
  const nextSlide = () => {
    setCurrentIndex((prevIndex) => (prevIndex + 3 < flooringOptions.length ? prevIndex + 3 : 0));
  };

  const prevSlide = () => {
    setCurrentIndex((prevIndex) => (prevIndex - 3 >= 0 ? prevIndex - 3 : flooringOptions.length - 3));
  };
  ...
  return (
    ...
    <div className="container">
      ...
      {/* Flooring Selection Carousel */}
      <div className="flooring-selection">
        <button className="carousel-btn prev" onClick={prevSlide}><i class="arrow left"></i></button>
        <div className="flooring-carousel">
          {flooringOptions.slice(currentIndex, currentIndex + 3).map((floor) => (
            <div key={floor.name} className={`flooring-option ${selectedFlooring.name === floor.name ? "selected" : ""}`} onClick={() => setSelectedFlooring(floor)}>
              <img src={floor.image} alt={floor.name} className="flooring-image" />
              <p>{floor.name}</p>
            </div>
          ))}
        </div>
        <button className="carousel-btn next" onClick={nextSlide}><i class="arrow right"></i></button>
      </div>
      </div>
